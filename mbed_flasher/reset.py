...
EXIT_CODE_NOT_SUPPORTED_METHOD_FOR_PLATFORM = 17
EXIT_CODE_IMPLEMENTATION_MISSING = 19
                ...
                for item in targets_to_reset:
                    if item['platform_name'] == 'K64F':
                        if method == 'simple' and 'serial_port' in item:
                            ...
                            print "edbg does not support reset"
                        ...
                        if method == 'simple':
                            ...
                            if platform.system() == 'Windows':
                                cmd = [flasher.exe, "-t", "edbg", "-i", "SWD", "-d", "atsam4e16e", "-s", item['target_id'], "reset"]
                            else:
                                cmd = ["sudo", flasher.exe, "-t", "edbg", "-i", "SWD", "-d", "atsam4e16e", "-s", item['target_id'], "reset"]
                            self.logger.info("resetting device")
